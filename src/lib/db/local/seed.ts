  ...
  return {
    ...
    qrCodes: [
      ...
      // Wynwood
      {
        ...
        partner_id: "partner-kyu",
        code: "KYU1",
        destination_url: "/q/quest-kyu",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-panther",
        quest_id: "quest-panther",
        venue_id: "venue-panther",
        partner_id: "partner-panther",
        code: "PANTHER1",
        destination_url: "/q/quest-panther",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-boxelder",
        quest_id: "quest-boxelder",
        venue_id: "venue-boxelder",
        partner_id: "partner-boxelder",
        code: "BOXELDER1",
        destination_url: "/q/quest-boxelder",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-gramps",
        quest_id: "quest-gramps",
        venue_id: "venue-gramps",
        partner_id: "partner-gramps",
        code: "GRAMPS1",
        destination_url: "/q/quest-gramps",
        status: "active",
        created_at: now,
      },
      {
        ...
        partner_id: "partner-coyo",
        code: "COYO1",
        destination_url: "/q/quest-coyo",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-wood-tavern",
        quest_id: "quest-wood-tavern",
        venue_id: "venue-wood",
        partner_id: "partner-wood",
        code: "WOOD1",
        destination_url: "/q/quest-wood-tavern",
        status: "active",
        created_at: now,
      },
      // Museums & landmarks
      {
        ...
        partner_id: "partner-pamm",
        code: "PAMM1",
        destination_url: "/q/quest-pamm",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-frost",
        quest_id: "quest-frost",
        venue_id: "venue-frost",
        partner_id: "partner-frost",
        code: "FROST1",
        destination_url: "/q/quest-frost",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-vizcaya",
        quest_id: "quest-vizcaya",
        venue_id: "venue-vizcaya",
        partner_id: "partner-vizcaya",
        code: "VIZCAYA1",
        destination_url: "/q/quest-vizcaya",
        status: "active",
        created_at: now,
      },
      {
        ...
        partner_id: "partner-bass",
        code: "BASS1",
        destination_url: "/q/quest-bass",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-art-deco",
        quest_id: "quest-art-deco",
        venue_id: "venue-artdeco",
        partner_id: "partner-artdeco",
        code: "ARTDECO1",
        destination_url: "/q/quest-art-deco",
        status: "active",
        created_at: now,
      },
      {
        id: "qr-brickell-key",
        quest_id: "quest-brickell-key",
        venue_id: "venue-brickell-key",
        partner_id: "partner-brickell",
        code: "BRICKELL1",
        destination_url: "/q/quest-brickell-key",
        status: "active",
        created_at: now,
      },
    ],
