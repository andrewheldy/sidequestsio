  ...
  return (
    <Layout>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {data.breadcrumbs.map((breadcrumb, index) => (
              <BreadcrumbCard key={`${breadcrumb.author}-${index}`} {...breadcrumb} delay={index * 100} />
            ))}
          </div>
        </div>
      </section>
      ...
      <CTASection
        ...
        description="Start your first quest in this category and leave a breadcrumb for the next explorer."
